...
exports.IMPs = exports.VP = exports.calculate = void 0;
...
*/
const calculate = function calculate(contract, overtricks, suit, VUL, doubled) {
  //contract: 1-7, overtricks: includes undertricks, suit: DIAMONDS, CLUBS, SPADES or HEARTS , VUL:TRUE=Vulnerable, Doubled: 0= not doubled, 1=doubled, 2=redoubled
  let score;
...
const VP = function vp(M, no_boards) {
  //M=margin, no_boards= number of boards
...
const IMPs = function IMPs(score1, score2) {
