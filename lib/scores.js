 ...
 */
export default function calculate(contract, overtricks, suit, VUL, doubled) { //contract: 1-7, overtricks: includes undertricks, suit: DIAMOND, CLUB, SPADE or HEART , VUL:TRUE=Vulnerable, Doubled: 0= not doubled, 1=doubled, 2=redoubled
    let score;
